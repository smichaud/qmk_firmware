...
[_LINUX] = LAYOUT_preonic_grid(
  ...
  KC_LCTL,              KC_LALT, KC_LGUI,  OSL(_ACCENTS), LOWER,   RAISE,   RAISE,   KC_SPC,  MO(_SYMBOLS), MO(_PERMANENT), KC_LALT, KC_LCTL
),
...
[_WINDOWS] = LAYOUT_preonic_grid(
  ...
  KC_LSFT, KC_Z,    KC_X,     KC_C,          KC_V,    KC_B,    KC_N,    KC_M,   KC_COMM,      KC_DOT,         KC_SLSH, KC_RSFT,
  KC_LCTL, KC_LALT, KC_LGUI,  OSL(_ACCENTS), LOWER,   KC_SPC,  KC_SPC,  RAISE,  MO(_SYMBOLS), MO(_PERMANENT), KC_LALT, KC_LCTL
),
...
[_PERMANENT] = LAYOUT_preonic_grid(
  _______, _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______, _______,
